...
import cloudsafe.util.*;

class Table {

	private static HashMap<String, Pair<String,Integer>> table = new HashMap<String, Pair<String,Integer>>();
	...
	public final void updateTable(Path tablePath, Integer tableSize)
	{
		try (FileChannel tableChannel = FileChannel.open(tablePath, READ, WRITE, CREATE))
		{
			...
			for(Object fileName : table.keySet())
			{
		    	...
		    	String line = (String)fileName + "\t=\t" + idAndSize.first + "\t" + idAndSize.second + '\n';	
